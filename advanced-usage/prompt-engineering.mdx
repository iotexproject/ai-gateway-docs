...
When building prompts for multi-turn conversations, you need to manage the context window to avoid exceeding model token limits. For a complete implementation of context window management, see [Smart Conversation Management](/advanced-usage/smart-conversation-management).
